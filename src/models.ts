...
export const BUILT_IN_MODELS: Model[] = [
  ...
  },
  {
    name: 'Gemma 3 (12B)',
    company: 'Google',
    size: 5600, url: 'https://huggingface.co/unsloth/gemma-3-12b-it-GGUF/resolve/main/gemma-3-12b-it-Q3_K_M.gguf',
    description: "Gemma 3,Google's new state-of-the-art models come in 1B,4B,12B,and 27B sizes. Gemma 3 has a 128K context window,and multilingual support."
  },
  {
    name: 'Gemma 3 (27B)',
